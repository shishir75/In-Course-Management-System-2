...
if (isset($_POST['add_teacher'])) {
	...
	if (empty($teacher_code)) {
		...
		if(in_array($ext,$allowed))
		{
		 	...
		 	$add_teacher = $getFromU->create("teachers", array("teacher_code" => $teacher_code, "teacher_name" => $teacher_name, "t_position" => $t_position, "t_speciality" => $t_speciality, "t_profileImage" => $file));
