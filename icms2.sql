...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2018 at 10:59 PM
...
CREATE TABLE `44_2103` (
  ...
  `05-08-2018` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `44_2103` (`id`, `roll`, `05-05-2018`, `05-08-2018`) VALUES
(1, 1696, 'present', 'absent'),
(2, 1703, 'present', 'present'),
(3, 1704, 'absent', 'present'),
(4, 1708, 'present', 'present'),
(5, 2106, 'absent', 'absent');
...
--
-- Table structure for table `44_2203`
--

CREATE TABLE `44_2203` (
  `id` int(11) NOT NULL,
  `roll` int(4) NOT NULL,
  `13-08-2018` varchar(10) DEFAULT NULL,
  `14-08-2018` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `44_2203`
--

INSERT INTO `44_2203` (`id`, `roll`, `13-08-2018`, `14-08-2018`) VALUES
(1, 1696, 'present', 'absent'),
(2, 1703, 'absent', 'absent'),
(3, 1704, 'present', 'present'),
(4, 1708, 'present', 'present'),
(5, 2106, 'present', 'absent');
...
--
-- Table structure for table `44_3107`
--

CREATE TABLE `44_3107` (
  `id` int(11) NOT NULL,
  `roll` int(4) NOT NULL,
  `03-08-2018` varchar(10) DEFAULT NULL,
  `30-07-2018` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `44_3107`
--

INSERT INTO `44_3107` (`id`, `roll`, `03-08-2018`, `30-07-2018`) VALUES
(1, 1696, 'present', 'absent'),
(2, 1703, 'present', 'present'),
(3, 1704, 'present', 'absent'),
(4, 1708, 'present', 'present'),
(5, 2106, 'present', 'absent');
...
CREATE TABLE `44_3108` (
  ...
  `01-08-2018` varchar(10) DEFAULT NULL,
  `02-08-2018` varchar(10) DEFAULT NULL,
  `03-08-2018` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `44_3108` (`id`, `roll`, `01-05-2018`, `01-08-2018`, `02-08-2018`, `03-08-2018`) VALUES
(1, 1696, 'present', 'present', 'absent', 'absent'),
(2, 1703, 'absent', 'present', 'present', 'absent'),
(3, 1704, 'present', 'present', 'absent', 'present'),
(4, 1708, 'present', 'present', 'present', 'present'),
(5, 2106, 'absent', 'present', 'absent', 'absent');
...
CREATE TABLE `44_3206` (
  ...
  `17-05-2018` varchar(10) DEFAULT NULL,
  `30-07-2018` varchar(10) DEFAULT NULL,
  `31-07-2018` varchar(10) DEFAULT NULL,
  `03-07-2018` varchar(10) DEFAULT NULL,
  `10-07-2018` varchar(10) DEFAULT NULL,
  `17-07-2018` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `44_3206` (`id`, `roll`, `09-05-2018`, `10-05-2018`, `17-05-2018`, `30-07-2018`, `31-07-2018`, `03-07-2018`, `10-07-2018`, `17-07-2018`) VALUES
(1, 1696, 'present', 'present', 'present', 'present', 'present', 'present', 'present', 'present'),
(2, 1703, 'present', 'present', 'present', 'present', 'absent', 'present', 'absent', 'present'),
(3, 1704, 'present', 'present', 'absent', 'present', 'present', 'present', 'present', 'absent'),
(4, 1708, 'present', 'absent', 'present', 'present', 'present', 'present', 'present', 'present'),
(5, 2106, 'present', 'present', 'absent', 'present', 'present', 'present', 'present', 'present');

-- --------------------------------------------------------

--
-- Table structure for table `45_2103`
--

CREATE TABLE `45_2103` (
  `id` int(11) NOT NULL,
  `roll` int(4) NOT NULL,
  `13-08-2018` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `45_2103`
--

INSERT INTO `45_2103` (`id`, `roll`, `13-08-2018`) VALUES
(1, 1926, 'present'),
(2, 1927, 'absent'),
(3, 1928, 'present'),
(4, 1929, 'present'),
...
(1, 'FKP', 'Md. Fazlul Karim Patwary', 'Professor', 'Database, Web Technology, Statistical Analysis', 'fkp.jpg'),
...
INSERT INTO `t_44_3108` (`id`, `roll`, `tutorial_1`, `tutorial_2`) VALUES
(1, 1696, '2', '5'),
(2, 1703, '14', '10'),
(3, 1704, '15', '12'),
(4, 1708, '17', '5'),
...
--
-- Table structure for table `t_45_2103`
--

CREATE TABLE `t_45_2103` (
  `id` int(11) NOT NULL,
  `roll` int(4) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `t_45_2103`
--

INSERT INTO `t_45_2103` (`id`, `roll`) VALUES
(1, 1926),
(2, 1927),
(3, 1928),
(4, 1929),
...
--
-- Indexes for table `t_45_2103`
--
ALTER TABLE `t_45_2103`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `44_2203`
--
ALTER TABLE `44_2203`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `44_3107`
--
ALTER TABLE `44_3107`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `45_2103`
--
ALTER TABLE `45_2103`
...
--
-- AUTO_INCREMENT for table `t_45_2103`
--
ALTER TABLE `t_45_2103`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
